#ifndef __ROBOTPATIENT_BMI270_H__
#define __ROBOTPATIENT_BMI270_H__
...
/*
struct BMI270_InterfaceData // JK: should be renamed to dev_info for consistency over libraries.
{
...
class BMI270 : public UniversalSensor
{
    public:
        // Constructor
        BMI270();
    ...
    private:
        ...
        static BMI2_INTF_RETURN_TYPE readRegistersI2C(uint8_t regAddress, uint8_t* dataBuffer, uint32_t numBytes, dev_info* interfaceData);
        //static BMI2_INTF_RETURN_TYPE readRegistersSPI(uint8_t regAddress, uint8_t* dataBuffer, uint32_t numBytes, dev_info* interfaceData);
        ...
        static BMI2_INTF_RETURN_TYPE writeRegistersI2C(uint8_t regAddress, const uint8_t* dataBuffer, uint32_t numBytes, dev_info* interfaceData);
        //static BMI2_INTF_RETURN_TYPE writeRegistersSPI(uint8_t regAddress, const uint8_t* dataBuffer, uint32_t numBytes, dev_info* interfaceData);
...
#endif /*__ROBOTPATIENT_BMI270_H__*/